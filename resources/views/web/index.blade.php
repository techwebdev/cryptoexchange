				...
				<div class="row">
					...
					<div class="col-lg-2 col-md-2 col-sm-12 col-12 d-flex align-self-center pl-0 xs-px-5">
						<div class="form-group">
							...
							<button type="submit" class="btn btn-primary btn-lg" id="btnValue" style="margin-top: 30px;"><i class="fas fa-angle-double-right"></i></button>
						</div>
					</div>
				</div>
						...
						<table class="table table-bordered table-hover">
							<thead>
								<tr class="thead-light">
									<th class="text-center"><font color="#2a80f073">Sr No.</font></th>
									<th class="text-center"><font color="#2a80f073">Currency</font></th>
									<th class="text-center"><font color="#2a80f073">Buy</font></th>
									<th class="text-center"><font color="#2a80f073">Sell</font></th>
								</tr>
							</thead>
							<tbody>
								@if(count($rate) > 0)
									<?php //echo "<pre>";print_r($rate); ?>
									@foreach($rate as $val)
									<tr>
										...
										<td class="align-middle text-center">
											<!-- @if($val["buy"]->to_currency == "PM")
												<img class="img-responsive" src="{{ asset('assets/images/pm.png') }}" style="width:50px;height:50px;">
											@elseif($val["buy"]->to_currency == "BTC")
												<img src="{{ asset('assets/images/bt.png') }}"  style="width:50px;height:50px;">
											@endif -->
											₦
											{{ $val["buy"]->calc_amount }}
										...
										<td class="align-middle text-center">
											<!-- @if($val["sell"]->from_currency == "PM")
												<img class="img-responsive" src="{{ asset('assets/images/pm.png') }}" style="width:50px;height:50px;">
											@elseif($val["sell"]->from_currency == "BTC")
												<img src="{{ asset('assets/images/bt.png') }}"  style="width:50px;height:50px;">
											@endif -->
											₦ {{ $val["sell"]->calc_amount }}
										</td>
									</tr>
									@endforeach	
								@else
