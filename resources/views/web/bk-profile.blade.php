                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    @if($type != "")
                        ...
                        <li class="nav-item col-lg-4 col-md-4 col-12 pl-0 pr-0">
                            <a class="nav-link active" id="bankInfo-tab" data-toggle="tab" href="#bankInfo" role="tab" aria-controls="bankInfo" aria-selected="false">Bank Details</a>
                        </li>
                        <li class="nav-item col-lg-4 col-md-4 col-12 pr-0 pl-0">
                    ...
                    @else
                        ...
                        <li class="nav-item col-lg-4 col-md-4 col-12 pl-0 pr-0">
                            <a class="nav-link" id="bankInfo-tab" data-toggle="tab" href="#bankInfo" role="tab" aria-controls="bankInfo" aria-selected="false">Bank Details</a>
                        </li>
                        <li class="nav-item col-lg-4 col-md-4 col-12 pr-0 pl-0">
                            <a class="nav-link" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Profile</a>
                        </li>
        ...
        <div class="tab-pane fade show row active justify-content-center" id="bankInfo" role="tabpanel" aria-labelledby="bankInfo-tab">
            <div class="col-md-3 col-lg-3 col-12 float-left">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    @if($type != "")
                        <a class="nav-link @if($type == '1') {{ __('active') }} @endif" id="v-pills-nigeria-tab" data-toggle="pill" href="#v-pills-nigeria" role="tab" aria-controls="v-pils-nigeria" aria-selected="true">Nigeria Account</a>
                        ...
                        <a class="nav-link @if($type == '3') {{ __('active') }} @endif" id="v-pills-btc-tab" data-toggle="pill" href="#v-pills-btc" role="tab" aria-controls="v-pills-btc" aria-selected="false">Bitcoin Account</a>
                    @else
                        <a class="nav-link active" id="v-pills-nigeria-tab" data-toggle="pill" href="#v-pills-nigeria" role="tab" aria-controls="v-pils-nigeria" aria-selected="true">Nigeria Account</a>
                        ...
                        <a class="nav-link" id="v-pills-btc-tab" data-toggle="pill" href="#v-pills-btc" role="tab" aria-controls="v-pills-btc" aria-selected="false">Bitcoin Account</a>
                    @endif
                </div>
            </div>
            <div class="col-md-9 col-lg-9 float-left">
                ...
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade @if($type == '1') {{ __('show active') }} @endif" id="v-pills-nigeria" role="tabpanel" aria-labelledby="nigeria-tab">
                        <div class="card">
                            <div class="card-header bg-primary text-white">Nigeria Account Bank Details</div>
                    ...
                    <div class="tab-pane fade @if($type == '3') {{ __('show active') }} @endif" id="v-pills-btc" role="tabpanel" aria-labelledby="btc-tab">
                        <div class="card">
                            <div class="card-header bg-primary text-white">Bitcoin Account</div>
                            ...
                            <form action="{{ route('profileupdate') }}" method="POST" name="chnagePasswordForm" id="chnagePasswordForm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="password" value="" placeholder="Enter new password" class="form-control">
                                    </div>
                                    <div class="form-group">
                                             ...
                                             @forelse($transaction as $val)
                                                 <tr>
                                                     ...
                                                     @if($val->from_currency == "BTC")
                                                        <td>{{ ($val->amount === "" ? 0 : $val->amount) }} {{ $val->from_currency }}</td>
                                                     @else
                                                        <td>{{ ($val->amount === "" ? 0 : $val->amount) - ($val->charges === "" ? 0 : $val->charges) }} {{ $val->from_currency }}</td>
                                                     @endif
                                                     <td>{{ $val->charges }}</td>
